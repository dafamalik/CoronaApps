              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: Text("Pandemi Covid-19 di Jakarta dilaporkan mulai melandai dengan rata-rata penambahan kasus tidak lebih dari 2.000 per hari. Angka ini perlahan turun setelah menyentuh puncaknya pada 12 Juli lalu dengan penambahan kasus harian sebesar 14.619, sebagaimana tertulis di laman. Dengan penurunan kasus ini, jumlah RT zona merah yang memiliki risiko penularan tinggi pun berkurang. Data Pemerintah Provinsi (Pemprov) DKI memperlihatkan, saat ini tersisa 38 RT saja yang masuk ke dalam kriteria zona merah."),
                  )
                ],
              ),
            )
